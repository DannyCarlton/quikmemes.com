...
(function($){
	...
	var MemeGenerator = function(element, options){
		...
		this.setFont = function(){
			MG.settings.defaultTextStyle.font=newfont;
		};
		
		
		this.setSize = function(){
			MG.settings.defaultTextStyle.size=fontSize;
		};
		
		this.setColor = function(){
			MG.settings.defaultTextStyle.color=fontColor;
		}
...
//				var im=document.getElementsByTagName("img")[1];
//				var im=$("#image-save");
//				var y=(im.height-5)*2.36;
//				var y=(im.height-5);
				//var y=(MG.originalSize[0]/2)*1.3;
		...
		this.cssPreview = {
			...
			drawText: function(text, x, y, maxWidth, fontSize, lineHeight, font, style, color, borderColor, borderWidth){
				...
				if(dropShadow) {var ds='1px 1px 3px #888888';}else{var ds='';}
				textElement.css({
					left: x,
					top: y,
					width: maxWidth,
